/**
 * Not a good example, it is not easy to understand adapter pattern, with this
 */
class Point
{
  constructor(x, y)
...
class VectorRectangle extends VectorObject
{
  constructor(x, y, width, height)
  {
    ...
    console.log('VectorRectangle', this);
  }
}
